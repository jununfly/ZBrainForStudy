...
切片进度：见 canonical 摘要 `docs/plans/MIGRATION.md`、Part1 归档路线图 `docs/plans/MIGRATION.md` 与当前 Part2 路线图 `docs/plans/MIGRATION.md`。
...
└── docs/plans/MIGRATION.md  # 改写方案 canonical 摘要
```
