 ...
 *   - match the `ZBrainConfig` field-name convention
 */
 ...
 * zbrain-flavored names we use a zbrain-prefixed form so they don't collide
 * with provider conventions: `database_url` becomes `ZBRAIN_DATABASE_URL`
