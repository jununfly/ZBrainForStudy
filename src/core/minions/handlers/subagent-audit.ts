 ...
 *                 `zbrain agent logs <job> --follow` has fresh content to
 ...
 *
 * `ZBRAIN_AUDIT_DIR` overrides the default ~/.zbrain/audit/ path — useful
 ...
 * files. Used by `zbrain agent logs <job>`. Returns chronological order.
 *
