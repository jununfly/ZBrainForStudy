...
/** True iff this content carries the brainstorm frontmatter marker (saved by `zbrain brainstorm --save`). */
...
/**
 * Read a single ad-hoc transcript file (`zbrain dream --input <file>`).
