 ...
 *
 * When `zbrain doctor --remediate --max-cost N` blows past the cap mid-run
 ...
 * completed so the user can continue with `zbrain doctor --remediate --resume`.
 *
 * Checkpoint file: `~/.zbrain/remediation/<plan_hash>.json`
