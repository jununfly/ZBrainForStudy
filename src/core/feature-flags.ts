 ...
 *
 * What the flag gates:
 *   - Parallel branch of `zbrain sync --all` (serial fallback otherwise)
 ...
 *
 * Disable path:
 *   zbrain config set sync.federated_v2 false
 *   zbrain jobs supervisor restart   # autopilot picks up the change
 *
