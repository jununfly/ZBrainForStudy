/**
 * skillpack/copy.ts — shared file-copy primitive for scaffold (zbrain→host)
 * and harvest (host→zbrain).
 *
 ...
 * secrets into zbrain's tree or escaping the intended skill dir.
 *
