 ...
 *
 * Namespace:
 *   Every entry's `key` starts with 'zbrain:calibration:v0.36.1.0:' so an
...
export const GSTACK_LEARNING_NAMESPACE = 'zbrain:calibration:v0.36.1.0:';
