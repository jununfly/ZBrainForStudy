...
export async function enrichEntity(
  ...
  try {
    await engine.addTimelineEntry(slug, { // zbrain-allow-direct-insert: auto-timeline reconciliation triggered by entity reference in source markdown
  ...
  try {
    await engine.addLink(slug, request.sourceSlug, `Entity mention from ${request.sourceSlug}`); // zbrain-allow-direct-insert: auto-link reconciliation triggered by entity reference in source markdown
