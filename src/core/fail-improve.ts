 ...
 *
 * Each operation writes to its own JSONL file (~/.zbrain/fail-improve/{operation}.jsonl).
...
// Lazy: ZBRAIN_HOME may be set after module load, so resolve at call time.
const getLogDir = () => zbrainPath('fail-improve');
