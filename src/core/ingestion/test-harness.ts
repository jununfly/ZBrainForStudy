 ...
 *
 * Exported as a public subpath (zbrain/ingestion/test-harness) and pinned by
 * tests/unit/public-exports.test.ts so it stays a versioned API for skillpack
 ...
 * Typical usage:
 *
 *   import { IngestionTestHarness, expectEvent } from 'zbrain/ingestion/test-harness';
 ...
 * `zbrain ingest test --watch` is for (CLI-side ephemeral brain for the
