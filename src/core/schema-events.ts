// v0.39 T15 — zbrain schema CLI event audit.
//
...
// NEVER throws.
//
// Feeds T23's `zbrain schema usage --since 30d` for the experimental-tier
 ...
 * `zbrain schema usage --since 30d`. Walks recent ISO-week files
