-- Calibration tables migration (1-3-3-1), SQLite dialect
...
--   - Type conversions for SQLite (no bigserial/timestamptz/jsonb/array):
--     BIGSERIAL → INTEGER PRIMARY KEY AUTOINCREMENT
--     TIMESTAMPTZ → TEXT (ISO-8601 string)
--     JSONB → TEXT (JSON-encoded)
--     TEXT[] → TEXT (JSON-encoded array as string)
--   - All defaults, CHECK constraints, foreign keys preserved exactly.
...
CREATE TABLE IF NOT EXISTS calibration_profiles (
    ...
    domain_scorecards       TEXT         NOT NULL, -- JSON-encoded
    pattern_statements      TEXT         NOT NULL, -- JSON-encoded array
    voice_gate_passed       BOOLEAN      NOT NULL,
    voice_gate_attempts     INTEGER      NOT NULL,
    active_bias_tags        TEXT         NOT NULL, -- JSON-encoded array
