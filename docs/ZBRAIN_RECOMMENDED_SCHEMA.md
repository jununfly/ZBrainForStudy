...
<!-- source: https://raw.githubusercontent.com/garrytan/zbrain/master/docs/ZBRAIN_RECOMMENDED_SCHEMA.md -->
...
At scale (500+ pages), add search tooling (embeddings, BM25, or tools like zbrain). At moderate scale, grep works well.
