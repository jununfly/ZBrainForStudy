 ...
 * `tests/unit/helpers/with-env.ts`. Process-global env mutations would leak across
...
const TEST_VALUE = 'http://proxy.example.tests/unit/v1';

const baseConfig: ZBrainConfig = {} as unknown as ZBrainConfig;
