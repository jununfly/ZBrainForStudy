...
describe('file-resolver', () => {
  ...
  beforeAll(() => {
    brainRoot = mkdtempSync(join(tmpdir(), 'zbrain-resolver-'));
    storageDir = mkdtempSync(join(tmpdir(), 'zbrain-resolver-storage-'));
...
describe('parseRedirect', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'zbrain-redirect-'));
  });
...
describe('parseMarker', () => {
  ...
  beforeAll(() => {
    tmpDir = mkdtempSync(join(tmpdir(), 'zbrain-marker-'));
  });
