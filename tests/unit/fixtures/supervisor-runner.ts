 ...
 *
 * Used by tests/unit/supervisor.test.ts integration tests. Separate file because
 ...
 *   SUP_AUDIT_DIR          — ZBRAIN_AUDIT_DIR override (default: tmpdir/supervisor-test)
 */
...
if (process.env.SUP_AUDIT_DIR) {
  process.env.ZBRAIN_AUDIT_DIR = process.env.SUP_AUDIT_DIR;
}
