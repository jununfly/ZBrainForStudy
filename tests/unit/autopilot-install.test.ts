/**
 * Tests for env-aware `zbrain autopilot --install`.
 *
 * Covers:
...
beforeEach(() => {
  ...
  tmp = mkdtempSync(join(tmpdir(), 'zbrain-install-test-'));
...
// exported ZBRAIN_DATABASE_URL or {OPENAI,ANTHROPIC}_API_KEY in zshrc and
