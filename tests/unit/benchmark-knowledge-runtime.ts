/**
 * Knowledge Runtime Benchmark — does the branch actually improve zbrain?
 *
 ...
 *    timeline is empty until user runs `zbrain extract timeline`.
 ...
 *
 * Usage: bun run tests/unit/benchmark-knowledge-runtime.ts
 *        bun run tests/unit/benchmark-knowledge-runtime.ts --json
 */
