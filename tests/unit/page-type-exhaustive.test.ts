...
//   1. ALL_PAGE_TYPES (the zbrain-base seed list) is non-empty and well-shaped.
//   2. Every base type round-trips through serialize/parse markdown without
//      loss. This is the "byte-for-byte zbrain-base equivalence" contract
...
//     seed list for the built-in `zbrain-base` pack; user packs add more.
