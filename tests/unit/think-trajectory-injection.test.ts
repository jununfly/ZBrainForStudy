/**
 * v0.40.2.0 — zbrain think trajectory injection contract.
 *
 * Confirms runThink:
...
// ─────────────────────────────────────────────────────────────────────
//
// zbrain think SKIPS candidates whose resolveEntitySlugWithSource
    ...
    await engine.executeRaw(`
      INSERT INTO facts (
        ...
        ('default', 'zelda', 'zelda met Marco', 'event', 'private',
         '2026-04-01T00:00:00Z', 'tests/unit', 'sess-zelda',
         NULL, NULL, NULL, NULL, 'meeting')
    `);
