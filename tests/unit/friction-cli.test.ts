...
describe('log subcommand', () => {
  test('writes a friction entry under ZBRAIN_HOME', () => {
...
describe('ZBRAIN_FRICTION_RUN_ID fallback (D19)', () => {
  ...
  test('log honors $ZBRAIN_FRICTION_RUN_ID', () => {
    process.env.ZBRAIN_FRICTION_RUN_ID = 'env-run';
    try {
