/**
 * Tests for `zbrain extract --source db` (v0.10.3 graph layer).
 *
 * Verifies the DB-source path of the unified `zbrain extract <subcommand>`
 * command. Companion to tests/unit/extract.test.ts which covers the fs-source path.
 *
...
describe('zbrain extract links --source db', () => {
...
describe('zbrain extract timeline --source db', () => {
  beforeEach(truncateAll);
...
describe('zbrain extract all --source db', () => {
  beforeEach(truncateAll);
