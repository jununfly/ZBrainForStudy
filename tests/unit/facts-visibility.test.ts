...
beforeAll(async () => {
  ...
  await engine.insertFact(
    { fact: 'world-visible', kind: 'fact', entity_slug: 'vis-test', source: 'tests/unit', visibility: 'world' },
    { source_id: 'default' },
  );
  await engine.insertFact(
    { fact: 'private-only', kind: 'fact', entity_slug: 'vis-test', source: 'tests/unit', visibility: 'private' },
    { source_id: 'default' },
  );
});
