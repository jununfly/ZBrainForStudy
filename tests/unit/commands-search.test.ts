/**
 * v0.32.3 — `zbrain search modes/stats/tune` CLI tests.
 *
...
describe('zbrain search modes (read-only dashboard)', () => {
...
describe('zbrain search modes --reset', () => {
...
describe('zbrain search tune (recommendations)', () => {
...
describe('zbrain search dispatch', () => {
