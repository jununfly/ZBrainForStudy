...
// R1: see tests/unit/think-with-calibration.test.ts — 'buildThinkSystemPrompt —
...
// R2: see tests/unit/eval-contradictions-calibration-join.test.ts —
...
describe('R2: contradictions probe UNCHANGED when no calibration profile', () => {
  test('null profile → null tag (output byte-identical to v0.32.6)', () => {
    const finding = {
      ...
      resolution_command: 'zbrain takes resolve N',
    };
...
// (tests/unit/source-isolation-pglite.test.ts and the matching e2e tests). The
...
describe('R4: existing read-side ops unchanged (covered structurally)', () => {
  test('this regression is covered by existing v0.34.1 source-isolation suite', () => {
    ...
    //   - tests/unit/source-isolation-pglite.test.ts
    //   - tests/unit/e2e/source-isolation-pglite.test.ts
...
// layer. Existing tests/unit/search-mode.test.ts coverage stays intact.
...
describe('R5: search modes unaffected by calibration wave', () => {
  test('this regression is covered by existing search-mode test suite', () => {
    ...
    // (tests/unit/search-mode.test.ts) catch the behavioral regression. This
...
describe('IRON RULE inventory', () => {
  test('all 5 regressions have an addressed status', () => {
    const inventory = {
      R1: 'covered (tests/unit/think-with-calibration.test.ts + this file)',
      R2: 'covered (tests/unit/eval-contradictions-calibration-join.test.ts + this file)',
