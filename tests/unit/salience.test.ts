 ...
 * tests/unit/e2e/salience-pglite.test.ts (PGLite, no DATABASE_URL needed).
 *
...
describe('v0.29 — salience SQL shape pinned via type contract', () => {
  ...
  // tests/unit/e2e/salience-pglite.test.ts and (optionally) the Postgres parity test.
...
describe('v0.29 — anomaly cohort buckets connect to the engine', () => {
  test('computeAnomaliesFromBuckets is exported and pure', () => {
    ...
    // covered exhaustively in tests/unit/anomalies.test.ts.
