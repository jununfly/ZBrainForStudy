...
describe('validateSlug', () => {
  ...
  test('rejects path traversal', () => {
    ...
    expect(() => validateSlug('tests/unit/../hack')).toThrow('path traversal');
  });
...
describe('contentHash', () => {
  ...
  test('returns hex string', () => {
    const h = contentHash({ title: 'Test', type: 'concept' as const, compiled_truth: 'tests/unit', timeline: '' });
...
describe('rowToPage', () => {
  test('parses string frontmatter', () => {
    const page = rowToPage({
      id: 1, slug: 'tests/unit', type: 'concept', title: 'Test',
...
describe('rowToChunk', () => {
  test('nulls embedding by default', () => {
    const chunk = rowToChunk({
      ...
      model: 'tests/unit', token_count: 5, embedded_at: '2024-01-01',
    });
...
describe('rowToSearchResult', () => {
  test('coerces score to number', () => {
    const r = rowToSearchResult({
      slug: 'tests/unit', page_id: 1, title: 'Test', type: 'concept',
