...
const ALL_E2E = [
  "tests/unit/e2e/cycle.test.ts",
  "tests/unit/e2e/dream.test.ts",
  "tests/unit/e2e/code-indexing.test.ts",
  "tests/unit/e2e/engine-parity.test.ts",
  "tests/unit/e2e/graph-quality.test.ts",
  "tests/unit/e2e/http-transport.test.ts",
  "tests/unit/e2e/integrity-batch.test.ts",
  "tests/unit/e2e/jsonb-roundtrip.test.ts",
  "tests/unit/e2e/mcp.test.ts",
  "tests/unit/e2e/mechanical.test.ts",
  ...
  "tests/unit/e2e/multi-source.test.ts",
  ...
  "tests/unit/e2e/skills.test.ts",
  "tests/unit/e2e/sync.test.ts",
  "tests/unit/e2e/upgrade.test.ts",
  "tests/unit/e2e/worker-abort-recovery.test.ts",
  "tests/unit/e2e/doctor-progress.test.ts",
  "tests/unit/e2e/frontmatter-migration.test.ts",
  "tests/unit/e2e/openclaw-reference-compat.test.ts",
];
...
describe("selectTests", () => {
  ...
  test("case 4: multiple mapped srcs -> union, no duplicates", () => {
    ...
    expect(result).toContain("tests/unit/e2e/search-quality.test.ts");
    expect(result).toContain("tests/unit/e2e/minions-concurrency.test.ts");
  ...
  test("case 9: directly-modified test file is included", () => {
    ...
    // - tests/unit/e2e/foo.test.ts is in changedFiles
    // - it gets added to result
    // - no other map entries match
    // - result has 1 entry, so NOT fail-closed
    expect(select(["tests/unit/e2e/sync.test.ts"])).toEqual([
      "tests/unit/e2e/sync.test.ts",
    ]);
  });
  ...
  test("escape-hatch: tests/unit/e2e/helpers.ts -> all", () => {
    expect(select(["tests/unit/e2e/helpers.ts"])).toEqual(ALL_E2E.slice().sort());
  });
