/**
 * Integration tests for `zbrain extract links --by-mention`.
 *
...
describe('zbrain extract links --by-mention — integration', () => {
  ...
  test('7. --source fs --by-mention rejected with paste-ready fix-hint', async () => {
    ...
    expect(stderrText).toContain('zbrain extract links --by-mention --source db');
  });
