...
beforeAll(async () => {
  ...
  await engine.insertFact(
    { fact: 'world fact', kind: 'fact', entity_slug: 'meta-pg', visibility: 'world', source: 'tests/unit' },
    { source_id: 'default' },
  );
  await engine.insertFact(
    { fact: 'private fact', kind: 'fact', entity_slug: 'meta-pg', visibility: 'private', source: 'tests/unit' },
    { source_id: 'default' },
  );
});
