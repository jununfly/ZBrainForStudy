...
describe('D24 NULL→non-NULL upsert race fix', () => {
  test('cold path: existing embedding NULL → take new', async () => {
    ...
    const chunks = await engine.getChunks('tests/unit/race-target', { sourceId: 'default' });
