 ...
 * brain page, commit to git, and sync to zbrain. It's deterministic —
 ...
 * zbrain jobs submit. No LLM involved.
 *
 ...
 *   - DATABASE_URL (Postgres with zbrain schema)
 ...
 *
 * Run:
 *   X_BEARER_TOKEN=... DATABASE_URL=... bun test tests/unit/e2e/bench-vs-openclaw/tweet-ingest.bench.ts
 */
