 ...
 *   2. Cross-check: zbrain orphans --count and doctor JSON orphan_ratio
...
describe('v0.42.0.0 e2e — orphan reduction via --by-mention', () => {
  ...
  test('2. cross-check — zbrain orphans count matches doctor JSON orphan_ratio numerator', async () => {
    ...
    // CLI `zbrain orphans --count` output.
    captureCli();
