 ...
 *
 * Seeds a synthetic brain matching tests/unit/fixtures/whoknows-eval.jsonl,
 * runs zbrain eval whoknows --skip-replay over the fixture, asserts
 ...
 * same pattern as tests/unit/e2e/search-quality.test.ts.
 */
...
describe('whoknows E2E — quality gate on synthetic fixture', () => {
  test('runs findExperts and the fixture quality gate at >= 80% hit rate', async () => {
    // v0.33.1.3: The shipped fixture at tests/unit/fixtures/whoknows-eval.jsonl
  ...
  test('shipped fixture at tests/unit/fixtures/whoknows-eval.jsonl loads and parses', () => {
    ...
    const fixture = readFixture(
      `${process.cwd()}/tests/unit/fixtures/whoknows-eval.jsonl`,
    );
