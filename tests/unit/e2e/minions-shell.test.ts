 ...
 *
 * Unit tests in tests/unit/minions-shell.test.ts cover the handler in detail
 ...
 *
 * Run: DATABASE_URL=... bun test tests/unit/e2e/minions-shell.test.ts
 */
...
describeE2E('E2E: Minions shell handler', () => {
  ...
  beforeAll(async () => {
    // The shell handler refuses to run unless ZBRAIN_ALLOW_SHELL_JOBS=1 is
