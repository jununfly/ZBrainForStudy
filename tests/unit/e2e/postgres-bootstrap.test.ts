 ...
 *
 * Codex caught that `tests/unit/e2e/helpers.ts:74` uses the standalone
 ...
 *
 * Run: DATABASE_URL=postgresql://... bun run test:e2e tests/unit/e2e/postgres-bootstrap.test.ts
 */
