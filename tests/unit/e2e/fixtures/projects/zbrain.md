...
provides the database layer. ZBrain stores, searches, and retrieves personal knowledge
...
ZBrain uses RAG as its core query mechanism. The compiled truth pattern is a deliberate
