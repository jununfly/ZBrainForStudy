...
- Ship hybrid search in ZBrain v0.3. This is the highest priority feature.
...
- [ ] Implement pgvector extension and embedding storage in ZBrain schema
- [ ] Build hybrid search with RRF scoring in ZBrain v0.3
...
Productive sync. The ZBrain search discussion was the most substantive — we identified
