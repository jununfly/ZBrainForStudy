 ...
 * plan). Generalized to drive any CLI binary (zbrain, openclaw, claude)
 ...
 *
 * What zbrain uses this for in v0.25.1:
 *   - tests/unit/e2e/skill-smoke-openclaw.test.ts: drive an openclaw session
 *     interactively after `zbrain skillpack install book-mirror`,
 ...
 * existing tests/unit/cli.test.ts pattern.
 */
 ...
 * to find `claude`, `openclaw`, `zbrain`, etc. without forcing tests
 * to hard-code paths.
 */
