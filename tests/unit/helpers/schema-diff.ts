 ...
 * `tests/unit/e2e/schema-drift.test.ts` wires them up to real engines; the unit
 * tests in `tests/unit/helpers/schema-diff.test.ts` exercise them with synthetic
