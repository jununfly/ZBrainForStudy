...
beforeAll(async () => {
  ...
  await engine.insertFact(
    { fact: 'world fact', kind: 'fact', entity_slug: 'meta-test', visibility: 'world', source: 'tests/unit' },
    { source_id: 'default' },
  );
  await engine.insertFact(
    { fact: 'private fact', kind: 'fact', entity_slug: 'meta-test', visibility: 'private', source: 'tests/unit' },
    { source_id: 'default' },
  );
});
